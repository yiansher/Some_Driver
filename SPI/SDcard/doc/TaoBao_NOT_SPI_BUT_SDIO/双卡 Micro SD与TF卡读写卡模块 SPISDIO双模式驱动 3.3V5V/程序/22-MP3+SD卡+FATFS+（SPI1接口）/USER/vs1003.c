 ...
 * 实验平台：野火STM32开发板
 * 硬件连接： ------------------------------
 *           | PA5-SPI1_SCK  : VS1003B-SCLK |
 *           | PA6-SPI1_MISO : VS1003B-SO       |
 *           | PA7-SPI1_MOSI : VS1003B-SI       |
...
void VS1003_SPI_Init(void)
{
    ...
    /* 配置 SPI1 引脚: PA5-SCK, PA6-MISO 和 PA7-MOSI */
...
void MP3_Start(void)
{
    u8  BassEnhanceValue = 0x00, TrebleEnhanceValue = 0x00;
    TRST_SET(0);
